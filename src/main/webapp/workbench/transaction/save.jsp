...
<script type="text/javascript" src="jquery/bs_typeahead/bootstrap3-typeahead.min.js"></script>
	<script>
		...
		<%--	}--%>
		<%--%>}--%>
		//将java中的map使用jackson转为json
		var json=<%=om.writeValueAsString(pMap)%>
...
<body>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;" action="workbench/transaction/save.do" id="saveTranForm" method="post">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="发传单2">
				<input type="hidden" value="e3d30dce8ad24bfa9fa62f210054f95b" name="activityid">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="6bc99d7657f84570a3de2cb655b473f5" name="contactsid">
			</div>
		</div>
